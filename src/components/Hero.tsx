    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <div className="animate-fade-in">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-white/80 backdrop-blur-sm border border-primary-200 shadow-lg animate-scale-in">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-gray-900 mb-6 sm:mb-8 leading-tight">
            <span className="block">Transforming Businesses</span>
            <span className="block mt-2">
              <span className="gradient-text-primary">Through Intelligent</span>
            </span>
            <span className="block mt-2 gradient-text-primary">AI Innovation</span>
          </h1>
          
          <p className="text-xl sm:text-2xl md:text-3xl text-gray-600 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed px-2 font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 max-w-5xl mx-auto mb-12 px-4">
            ...
            <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="text-3xl sm:text-4xl font-bold gradient-text-primary mb-2">100%</div>
            ...
            <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <div className="text-sm sm:text-base text-gray-600 font-semibold">Expert Support</div>
            </div>
            <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="text-3xl sm:text-4xl font-bold gradient-text-primary mb-2">5+</div>
              <div className="text-sm sm:text-base text-gray-600 font-semibold">Years Experience</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-8 px-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8">
              {['Healthcare', 'Finance', 'Enterprise', 'Startups'].map((industry, idx) => (
